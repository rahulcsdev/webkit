...
export const updateTimeEntry=gql`mutation ($where: TimeEntryWhereUniqueInput!,$data: TimeEntryUpdateInput!) {
...
query ($where:UserWhereInput , $take: Int, $skip: Int, $orderBy: [UserOrderByInput!]) {
  ...
  query ($where:TaskWhereInput , $take: Int, $skip: Int, $orderBy: [TaskOrderByInput!]) {
    ...
    export const getMilestoneDetails=gql`query($where: MilestoneWhereUniqueInput!){
...
query ($where:TimeEntryWhereInput , $take: Int, $skip: Int, $orderBy: [TimeEntryOrderByInput!]) {
...
export const finduserRole=gql`query($where: UserWhereUniqueInput!){
  user(where: $where){
    id
    name
    role
...
export const addUser=gql` mutation CreateUser($data: UserCreateInput!) {
